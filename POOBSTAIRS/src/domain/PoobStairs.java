...
public class PoobStairs {
	...
	/**
	 * Se encarga de mover la pieza en juego n posiciones
	 * 
	...
	public int playMachine() {
		...
		int[] movementSimulate2 =new int[] {0,0,0,0};
		...
		if (movementSimulate1[0] > movementSimulate2[0]) {
			getTurn().changeStats(movementSimulate1[1], movementSimulate1[2], movementSimulate1[3],
					movementSimulate1[0]);
			if (getTurn().getPiecePosition() != movementSimulate1[0]) {
				board.changePieceBoard(getTurn().getPiecePosition(), movementSimulate1[0], getTurn().getPiece());
			}
		} else {
			getTurn().changeStats(movementSimulate2[1], movementSimulate2[2], movementSimulate2[3],
					movementSimulate2[0]);
			if (getTurn().getPiecePosition() != movementSimulate2[0]) {
				board.changePieceBoard(getTurn().getPiecePosition(), movementSimulate2[0], getTurn().getPiece());
			}
		}
